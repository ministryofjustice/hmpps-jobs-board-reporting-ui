...
The following example is `--dry-run` mode - which will allow for testing. GitHub Actions normally runs this command with actual secret values (from AWS secret manager), and also updates the chart's application version to match the release version:
